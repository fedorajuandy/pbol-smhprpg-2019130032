 ...
 */
public class FXMLClassSkillsController implements Initializable {
    ...
    private void saveClicked(ActionEvent event) {
        ClassSkillModel n = new ClassSkillModel();
        n.setClass_id(Integer.parseInt(txtId.getText()));
        n.setSkill_id(Integer.parseInt(txtId1.getText()));
        
        FXMLMainMenuController.dtcs.setClassSkillModel(n);
        if (FXMLMainMenuController.dtcs.validasi(n.getClass_id(), n.getSkill_id()) <= 0) {
            if (FXMLMainMenuController.dtcs.insert()) {
