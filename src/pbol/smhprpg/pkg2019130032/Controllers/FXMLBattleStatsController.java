...
public class FXMLBattleStatsController implements Initializable {
    ...
    public void showData() {
        ObservableList<BattleStatModel> data = FXMLDocumentController.dtbt.load();
    ...
    private void searchData(KeyEvent event) {
        ...
        if (key != "") {
            ObservableList<BattleStatModel> data = FXMLDocumentController.dtbt.searchItems(key, key, key);
            if (data != null) {
                tbv.getColumns().clear();
                tbv.getItems().clear();
    ...
    private void deleteClicked(ActionEvent event) {
        ...
        if (a.getResult() == ButtonType.YES) {
           if (FXMLDocumentController.dtbt.delete(s.getId())) {
