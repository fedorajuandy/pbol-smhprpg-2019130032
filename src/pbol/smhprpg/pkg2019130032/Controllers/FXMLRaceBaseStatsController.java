 ...
 */
public class FXMLRaceBaseStatsController implements Initializable {
    ...
    public void execute(RaceBaseStatModel d) {
        id = d.getRace_id();
    ...
    private void saveClicked(ActionEvent event) {
        RaceBaseStatModel n = new RaceBaseStatModel();
        ...
        FXMLMainMenuController.dtrbs.setRaceBaseStatModel(n);
        if (edited) {
            if (FXMLMainMenuController.dtrbs.update()) {
        ...
        } else if (FXMLMainMenuController.dtrbs.validasi(n.getRace_id(), n.getBase_stat_id()) <= 0) {
            if (FXMLMainMenuController.dtrbs.insert()) {
