 ...
 */
public class FXMLClassBattleStatsController implements Initializable {
    ...
    public void execute(ClassBattleStatModel d) {
        id = d.getClass_id();
    ...
    private void saveClicked(ActionEvent event) {
        ClassBattleStatModel n = new ClassBattleStatModel();
        ...
        FXMLMainMenuController.dtcbt.setClassBattleStatModel(n);
        if (edited) {
            if (FXMLMainMenuController.dtcbt.update()) {
        ...
        } else if (FXMLMainMenuController.dtcbt.validasi(n.getClass_id(), n.getBattle_stat_id()) <= 0) {
            if (FXMLMainMenuController.dtcbt.insert()) {
