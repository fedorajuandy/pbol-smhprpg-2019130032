 ...
 */
public class FXMLHeroBaseStatsController implements Initializable {
    ...
    public void execute(HeroBaseStatModel d) {
        id = d.getHero_id();
    ...
    private void saveClicked(ActionEvent event) {
        HeroBaseStatModel n = new HeroBaseStatModel();
        ...
        } else if (FXMLMainMenuController.dthbs.validasi(n.getHero_id(), n.getBase_stat_id()) <= 0) {
            if (FXMLMainMenuController.dthbs.insert()) {
