 ...
 */
public class FXMLTraitBaseStatsController implements Initializable {
    ...
    public void execute(TraitBaseStatModel d) {
        id = d.getTrait_id();
        ...
        if (id != 0 && id1 != 0) {
          ...
          txtInput.setText(Integer.toString(d.getVal()));
    ...
    private void saveClicked(ActionEvent event) {
        TraitBaseStatModel n = new TraitBaseStatModel();
        n.setTrait_id(Integer.parseInt(txtId.getText()));
        n.setBase_stat_id(Integer.parseInt(txtId1.getText()));
        n.setVal(Integer.parseInt(txtInput.getText()));
        
        FXMLMainMenuController.dttbs.setTraitBaseStatModel(n);
        if (edited) {
            if (FXMLMainMenuController.dttbs.update()) {
        ...
        } else if (FXMLMainMenuController.dttbs.validasi(n.getTrait_id(), n.getBase_stat_id()) <= 0) {
            if (FXMLMainMenuController.dttbs.insert()) {
