 ...
 */
public class FXMLClassTraitsController implements Initializable {
    ...
    private void saveClicked(ActionEvent event) {
        ClassTraitModel n = new ClassTraitModel();
        n.setClass_id(Integer.parseInt(txtId.getText()));
        n.setTrait_id(Integer.parseInt(txtId1.getText()));
        
        FXMLMainMenuController.dtct.setClassTraitModel(n);
        if (FXMLMainMenuController.dtct.validasi(n.getClass_id(), n.getTrait_id()) <= 0) {
            if (FXMLMainMenuController.dtct.insert()) {
